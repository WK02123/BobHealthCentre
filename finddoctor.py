...
class Ui_Form:
    def __init__(self):
        self.python_executable = "C:/BobHealthCentre/.venv/Scripts/python.exe"

    def setupUi(self, Form, user_id, token, user_email,username):
        self.Form = Form
        ...
        clinic_label = tk.Label(self.widget_3, text="Klinik Joe Fernandez", font=("Arial", 24), bg='#D0FDFF', fg='#000000')
        clinic_label.place(x=15, y=95, width=400, height=32)
    ...
    def button1(self):
        self.Form.withdraw()  # Hide the current form (finddoctor page)
    ...
    def make_appointment(self):
        ...
        subprocess.call([python_executable, "C:/BobHealthCentre/.venv/makeappointment.py", self.user_id, self.token, self.user_email, self.username])
    ...
    def open_find_doc2(self):
        ...
        subprocess.call([python_executable, "C:/BobHealthCentre/.venv/finddoctor2.py", self.user_id, self.token, self.user_email, self.username])  # Pass user details
...
if __name__ == "__main__":
    ...
    root = tk.Tk()
    ui = Ui_Form()
    ui.setupUi(root, user_id, token, user_email,username)
    root.mainloop()
