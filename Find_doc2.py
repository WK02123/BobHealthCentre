...
class Ui_Form:
    def setupUi(self, Form):
        ...
        self.b6 = tk.Button(self.widget_4, text="Clinic 1", bg='#78CBFF', fg='#873C00', command=self.open_find_doc)
    ...
    def open_find_doc(self):
        self.Form.withdraw()  # Hide the current form
        subprocess.call(["python", "Find_doc.py"])  # Open Find_doc.py
